...
```
see code reference here: <a target="_blank" href="/articles-content/optimizing-nextjs-dashboard#optimized-main-page" className="ref-link">Optimized Main Page</a>.
...
![Heavy Chart Code](/images/articles/optimizing-nextjs/heavy/heavyChartCode.png)
...
![Optimized Chart Code](/images/articles/optimizing-nextjs/optimized/OptimizedChartCode.png)
