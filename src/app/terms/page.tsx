    ...
    <div>
      <div className="flex justify-center items-center py-32">
        <div className="max-w-[1350px] flex flex-col gap-10 px-10 md:px-0">
          ...
          <div>
            <h3 className="text-lg md:text-3xl mb-5 font-alro-reg">1.  Introduction</h3>
            <p className="text-sm md:text-base text-justify font-azeret-mono">
          ...
          <div>
            <h3 className="text-lg md:text-3xl mb-5 font-alro-reg">2.  Project Engagement</h3>
            <p className="text-sm md:text-base text-justify font-azeret-mono">
          ...
          <div>
            <h3 className="text-lg md:text-3xl mb-5 font-alro-reg">3.  Work Process</h3>
            <p className="text-sm md:text-base text-justify font-azeret-mono">
          ...
          <div>
            <h3 className="text-lg md:text-3xl mb-5 font-alro-reg">5.  Payment Terms</h3>
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-justify font-azeret-mono">In cases where payment is structured monthly:</p>
            <ul className="list-disc text-sm md:text-base text-justify pl-5 font-azeret-mono">
              <li>
          ...
          <div>
            <h3 className="text-lg md:text-3xl mb-5 font-alro-reg">7.  Refund Policy</h3>
            <ul className="list-disc text-sm md:text-base text-justify pl-5 font-azeret-mono">
          ...
          <div>
            <h3 className="text-lg md:text-3xl mb-5 font-alro-reg">8.  Usage Rights</h3>
            <p className="text-sm md:text-base text-justify font-azeret-mono">
          ...
          <div>
            <h3 className="text-lg md:text-3xl mb-5 font-alro-reg">9.  Communication</h3>
            <p className="text-sm md:text-base text-justify font-azeret-mono">
